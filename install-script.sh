...
#Install (yay)
yay -S nerd-fonts-complete ttf-symbola timeshift code-git lbry lightdm-webkit-theme-aether nerd-fonts-mononoki brave-nightly-bin discord-canary simplenote cmatrix-git toilet betterdiscordctl-git spotify spicetify-cli picom-tryone-git -y
...
rm -rf ~/.config/bumblebee-status/bumblebee_status/modules/contrib/weather.py 
rm -rf ~/.config/bumblebee-status/bumblebee_status/modules/contrib/arch-update.py 
rm -rf ~/.config/bumblebee-status/bumblebee_status/modules/contrib/kernel.py 
rm -rf ~/.config/bumblebee-status/bumblebee_status/modules/contrib/playerctl.py
rm -rf ~/.config/bumblebee-status/bumblebee_status/modules/core/time.py
rm -rf ~/.config/bumblebee-status/bumblebee_status/modules/core/date.py
rm -rf ~/.config/bumblebee-status/bumblebee_status/modules/contrib/memory.py

cp -a ~/bumblebee-modules/weather.py   ~/.config/bumblebee-status/bumblebee_status/modules/contrib/
cp -a ~/bumblebee-modules/arch-update.py  ~/.config/bumblebee-status/bumblebee_status/modules/contrib/
cp -a ~/bumblebee-modules/kernel.py   ~/.config/bumblebee-status/bumblebee_status/modules/contrib/
cp -a ~/bumblebee-modules/playerctl.py  ~/.config/bumblebee-status/bumblebee_status/modules/contrib/
cp -a ~/bumblebee-modules/time.py ~/.config/bumblebee-status/bumblebee_status/modules/core/
cp -a ~/bumblebee-modules/date.py ~/.config/bumblebee-status/bumblebee_status/modules/core/
cp -a ~/bumblebee-modules/memory.py ~/.config/bumblebee-status/bumblebee_status/modules/core/
cd ~
